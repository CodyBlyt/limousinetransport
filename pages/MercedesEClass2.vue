  ...
  <div>
    <div class="py-12 select-none bg-theme-700">
      ...
      <div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-design.jpg" alt="Paris" class="center">
        <p style="font-size:11px;" class="center">*For illustrative purposes only. Private Mercedes Benz E-Class limousines are unmarked vehicles.</p>
			</div>
     <section>
   <div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-gray-200 divide-x divide-gray-200">
                      <tr class="divide-x divide-gray-200">
                        ...
                        <td class="px-6 py-4 text-left"><font style ="text-decoration: underline;">Mercedes E-Class Transfer</font></td>
...
<hr>
     ...
     <div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-new (1).jpg" alt="Paris" class="center">
			</div>
     <section>
       <br><h2 style="font-size:28px;" class="center"><a name="Singapore Changi Airport" href="#"><b>Mercedes E-Class Package Rates</b></a></h2>
   <div class="Table1">
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6">
        <div class="space-y-6">
                  ...
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-gray-200 divide-x divide-gray-200">
                      <tr class="divide-x divide-gray-200">
                        ...
                        <td class="px-6 py-4 text-left">$650</td>
                        <td class="px-6 py-4 text-left">$65 per additional hour</td>
                      </tr>
                    </tbody>
                    <tbody class="bg-white divide-gray-200 divide-x divide-gray-200">
                      <tr class="divide-x divide-gray-200">
                        <td class="px-6 py-4 text-left">Half-Day Package (6 consecutive hrs)</td>
                        <td class="px-6 py-4 text-left">$420</td>
                        <td class="px-6 py-4 text-left">$70 per additional hour</td>
                      </tr>
                    </tbody>
                    <tbody class="bg-white divide-gray-200 divide-x divide-gray-200">
                      <tr class="divide-x divide-gray-200">
                        <td class="px-6 py-4 text-left">Hourly Disposal (3 consecutive hrs)</td>
                        <td class="px-6 py-4 text-left">$225</td>
...
<hr>
    ...
    <div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-seating.jpg" alt="Paris" class="center">
			</div>
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6"> 
        <h3 style="font-size:28px;"><a name="Singapore Changi Airport" href="#"><b>Mercedes E-Class Seating Capacity</b></a></h3>
      <p>Comfortable:</p><div style="display:block;">2<img align="left" src="~assets/img/pax.gif" border="0"></div>
...
<div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-trunk.jpg" alt="Paris" class="center">
			</div>
      
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6"> 
      <h2 style="font-size:28px;"><a name="Singapore Changi Airport" href="#"><b>Trunk Space</b></a></h2>
      <p>450(l), or 15.9(cu ft) of trunk volume allows you to carry up to two (2) sets of stowed luggage and two (2) sets of hand luggage.</p>
</div>
<hr>

<div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-specs.gif" alt="Paris" class="center">
			</div>
      
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6"> 
      <h2 style="font-size:28px;"><a name="Singapore Changi Airport" href="#"><b>Mercedes E-Class Specifications</b></a></h2>
      <p>Model: Mercedes Benz E200
<br><br>
Maximum Seating capacity: 4 adult passengers + 1 driver
<br><br>
Comfortable Seating capacity: 2 adult passengers + 1 driver
<br><br>
Trunk capacity: 450(l) or 15.9(cu ft)</p>
</div>
<hr>

<div class="max-w-6xl px-4 mx-auto prose text-justify"><br><br>
        <img src="~assets/img/mercedes-e-class-comfort.jpg" alt="Paris" class="center">
			</div>
      
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6"> 
      <h2 style="font-size:28px;"><a name="Singapore Changi Airport" href="#"><b>Mercedes E-Class Services</b></a></h2>
      <p> • Executive Chauffeur&emsp;&emsp;&emsp;&emsp;• Corporate Events<br><br><br><br>
          ...
          • <font style="color:#C24641; text-decoration: underline;" >Airport Transfers</font>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;• Singapore Tours<br><br><br><br>
